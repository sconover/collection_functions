CollectionFunctions = (function(){  
  ...
  var mainFunction = function(userFeatures) {
    ...
    var factory = (function me(features, arrayFunctions, createAcrossCF) {
      ...
      functionsForExport.lastCost = lastCost
      ...
      if (feature("newCollection") && feature("append") && feature("iterator")) functionsForExport.select = select
      ...
      if (feature("newCollection") && feature("append") && feature("iterator")) functionsForExport.map = map
      ...
      if (feature("iterator") && feature("nothing") && feature("equals")) {
      ...
      if (feature("iterator") && feature("nothing") && feature("equals") && feature("newCollection") && feature("append"))
      ...
      if (feature("iterator") && feature("newCollection") && feature("isCollection") && feature("append")) 
      ...
      */
      ...
      if (feature("nothing") && feature("iterator") && feature("equals") && feature("newCollection")) 
      ...
      var more = {
        differ:differ,
        inspect:inspect, intersect:intersect,
        iterator:iterator,
        pluck:pluck,
        remove:remove,
        size:size, slice:slice, splice:splice,
        without:without
      }
