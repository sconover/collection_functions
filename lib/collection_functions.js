CollectionFunctions = (function(){  
  ...
  var mainFunction = function(userArgs) {
    
    var factory = (function me(args, arrayFunctions, createAcrossCF) {
      
      var __iterator = args.iterator
      var __nothing = args.nothing
      var __equals = args.equals
      var __newCollection = args.newCollection
      var __append = args.append
      var __isCollection = args.isCollection
      var __size = args.size
    ...
    var f = factory(userArgs, arrayCF.functions)
    f.appendFeatures = function(newFeatures) {
      var combined = {}
      for(var k in userArgs) {combined[k] = userArgs[k]}
